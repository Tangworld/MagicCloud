  ...
  <div class="header">
      ...
      <div class="dl-title">
        <a href="#" title="文档库地址" target="_blank"><!-- 仅仅为了提供文档的快速入口，项目中请删除链接 -->
          <span class="lp-title-port">MagicCloud</span><span class="dl-title-text">旅游比价系统用户个人中心</span>
        </a>
      </div>

    <div class="dl-log"><span class="dl-log-user"><s:property value="#session.login"/></span><a href="###" title="退出系统" class="dl-log-quit">[退出]</a><a href="#" title="文档库" class="dl-log-quit">文档库</a>
    </div>
  </div>
   <div class="content">
    <div class="dl-main-nav">
      ...
      <ul id="J_Nav"  class="nav-list ks-clear">
        ...
        <li class="nav-item"><div class="nav-item-inner nav-order">基本信息</div></li>
        <li class="nav-item"><div class="nav-item-inner nav-inventory">浏览记录</div></li>
      ...
      var config = [{
          ...
          menu:[{
            ...
            menu:[{
                text:'用户个人信息',
                items:[
                  {id:'code',text:'用户个人信息展示',href:'form/code.jsp'},
...
//                ]
            ...
            menu:[{
                text:'用户浏览记录',
                items:[
                  {id:'code',text:'用户浏览记录',href:'search/code.jsp'},
